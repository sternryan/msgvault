...
func TestStore_AttachmentPathsUniqueToSource(t *testing.T) {
	...
	err = f.Store.UpsertAttachment(uniqueMsg, "u.pdf", "application/pdf", "aa/uniquehash", "uniquehash", "", 10)
	...
	err = f.Store.UpsertAttachment(sharedMsg, "s.pdf", "application/pdf", "bb/sharedhash", "sharedhash", "", 20)
	testutil.MustNoErr(t, err, "upsert shared attachment in default source")
	err = f.Store.UpsertAttachment(otherMsgID, "s.pdf", "application/pdf", "bb/sharedhash", "sharedhash", "", 20)
	...
	err = f.Store.UpsertAttachment(emptyPathMsg, "e.pdf", "application/pdf", "", "emptypathhash", "", 40)
	...
	err = f.Store.UpsertAttachment(dupMsg, "u.pdf", "application/pdf", "aa/uniquehash", "uniquehash", "", 10)
...
func TestStore_IsAttachmentPathReferenced(t *testing.T) {
	...
	err := f.Store.UpsertAttachment(msgID, "a.pdf", "application/pdf", "aa/hash1", "hash1", "", 10)
